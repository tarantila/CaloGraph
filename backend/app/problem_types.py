...
PROVIDER_NOT_AVAILABLE = f"{PROBLEM_BASE}provider-not-available"
PROVIDER_SELECTION_UNAVAILABLE = f"{PROBLEM_BASE}provider-selection-unavailable"
PROVIDER_SELECTION_NOT_READY = f"{PROBLEM_BASE}provider-selection-not-ready"
