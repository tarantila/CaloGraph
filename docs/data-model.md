...
- `tracking_quality_settings`: Legacy-Einstellungen aus der früheren Vollständigkeitsheuristik; werden für neue Auswertungen nicht mehr verwendet.
...
- `tracking_overrides`: optionale manuelle Datenstatus-Markierung pro lokalem Tag.
